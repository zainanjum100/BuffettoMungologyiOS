...
public class AudioPlayer: NSObject {
    ...
    func setAudioSession(active: Bool) {
        #if os(iOS) || os(tvOS)
            //_ = try? AVAudioSession.sharedInstance().setCategory(AVAudioSession.Category.playback, mode: AVAudioSession.CategoryOptions.mixWithOthers)
            ...
            _ = try? AVAudioSession.sharedInstance().setMode(AVAudioSession.Mode.moviePlayback)
