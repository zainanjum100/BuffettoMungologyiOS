...
public typealias Index2 = Int
public typealias Closure = () -> Void
public typealias SelectionClosure = (Index2, String) -> Void
public typealias MultiSelectionClosure = ([Index2], [String]) -> Void
public typealias ConfigurationClosure = (Index2, String) -> String
public typealias CellConfigurationClosure = (Index2, String, DropDownCell) -> Void
...
public final class DropDown: UIView {
	...
	*/
	...
	fileprivate var selectedRowIndices = Set<Index2>()
...
extension DropDown {
	...
	*/
	...
	public func selectRow(at index: Index2?) {
		if let index = index {
            tableView.selectRow(
    ...
    public func selectRows(at indices: Set<Index2>?) {
        indices?.forEach {
            selectRow(at: $0)
        }
	...
	public func deselectRow(at index: Index2?) {
    ...
    public func deselectRows(at indices: Set<Index2>?) {
        indices?.forEach {
            deselectRow(at: $0)
        }
    }
	...
	public var indexForSelectedRow: Index2? {
    ...
    @objc public func selectRow(_ index: Int) {
        self.selectRow(at:Index2(index))
    }
    ...
    @objc public func deselectRow(_ index: Int) {
        tableView.deselectRow(at: IndexPath(row: Index2(index), section: 0), animated: true)
    }
